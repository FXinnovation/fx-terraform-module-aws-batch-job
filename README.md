...
This module doesn't create the Batch compute environment, you can call our batch module in order to create it (please take a look at [examples/default/](examples/default/)).

This module need at least 4 variables :

* name: a name for your Batch Job
* job\_queue\_arn: output from Batch module
* schedule\_expression or event\_pattern: optional but your job will never be launched if both are undefined
* properties: your job definition
...
| event\_role\_description | Description of the IAM policy. | `string` | `"Service Role for EventBridge / Batch Job"` | no |
