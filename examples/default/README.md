...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_compute_environment"></a> [compute\_environment](#module\_compute\_environment) | git::https://scm.dazzlingwrench.fxinnovation.com/fxinnovation-public/terraform-module-aws-batch.git | 0.1.1 |
